# Briefing — Thorin, King of Durin's Folk

- **Modo:** improve (rodada 1 — redução de custo)
...
- **Faltantes (fonte: `export_175e22...csv`, filtradas pela lista atual):** Cloudshift, Slip On the Ring, Gandalf the White, Lightning Greaves, Bifur, Melodic Rider, Dwalin, Weaponmaster, Bilbo, Unexpected Adventurer, Dáin of the Ancient Halls, Thorin, Company's Leader, Long-Lost Lances, Ori, Plate Stacker. (Sword of Hearth and Home e The Reaver Cleaver constam no CSV, mas já saíram do deck.)
- **Trocas feitas pelo usuário em 2026-09-15:** Ragged Short Spear → Thrór's Map; The Reaver Cleaver → Key to the Side-Door; Sword of Hearth and Home → Sting, Bilbo's Sword. **As três entradas já são do usuário.**
- **Intocáveis:** Bifur, Melodic Rider. **Gandalf the White** fica, a menos que apareça equivalente barato (ETB dobrado + flicker de Cloudshift/Slip On the Ring).
- **Queixas (2 partidas, "achismo"):** 1ª partida demorou para baixar Anões; 2ª faltaram Anões; deck parece "seco" (poucas mágicas/draw).
- **Alvos protegidos (consertar, não cortar):** densidade e velocidade de Anões; fluxo de cartas.

## Decklist atual (100)
Comandante: Thorin, King of Durin's Folk
